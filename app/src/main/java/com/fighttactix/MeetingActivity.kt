...
public class MeetingActivity: AppCompatActivity() {
    ...
    fun showMultiChoice(view: View) {
        val meetingCheckinButton: TextView = view.findViewById(R.id.checkin_button) as TextView
...
//                    val str = StringBuilder()
    ...
    fun addToCalendar(index: Int){
        ...
        calIntent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME,
                meetingObjects[index].date.time + 60*60*1000)
        calIntent.putExtra(CalendarContract.EXTRA_EVENT_END_TIME,
                meetingObjects[index].date.time + 60*60*1000 + 90*60*1000)
